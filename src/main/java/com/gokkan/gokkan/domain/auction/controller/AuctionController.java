...
public class AuctionController {
	...
	public ResponseEntity<Page<ListResponse>> myAuctionBidList(
		...
		@Parameter(description = "경매 상태(auctionId)", required = true, example = "/list/wait-payment?auctionStatus=경매중, /list/wait-payment?auctionStatus=마감, /list/wait-payment?auctionStatus=결재대기")
